    ...
    if '.topo' in name:
        ...
        for i in range(len(content)):
            ...
            if content[i][2] == '2':
                ...
                cdict[str(content[i][0] + ','+content[i][1])] = 1
        #print(cdict)
        cycles= nx.cycle_basis(G.to_undirected())    #nx.cycle_basis(G, 0)   #list(nx.simple_cycles(G))     #list(nx.find_cycle(G, orientation="ignore"))   #nx.cycle_basis(G.to_undirected())     
